...
playerbullet = CreateProjectile("heartyellow0", Player.x, Player.y)
...
Encounter.SetVar("wavetimer", 8.00)
Arena.Resize(155,130)

--Square pattern

table.insert(bots, oblib.LaserBot.new( { simple = true, startX = 700, startY = 400,  time = ourTime+0.1, xspeed = -350, rotation = 0, color = BLUE }))
...
table.insert(bots, oblib.LaserBot.new( { simple = true, startX = 1150, startY = 400, time = ourTime+3.4, xspeed = -350, rotation = 0, color = ORANGE }))
...
table.insert(bots, oblib.LaserBot.new( { simple = true, startX = 950, startY = 400,  time = ourTime+5.6, xspeed = -350, rotation = 0, color = ORANGE }))
if (GetGlobal("attackNum") > 109) then
