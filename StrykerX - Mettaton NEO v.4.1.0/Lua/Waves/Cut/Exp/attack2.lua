...
table.insert(gbs, oblib.GasterBlaster.new({ startX = -90, startY = 240, endX = 90, endY = 270, time = ourTime+6.9, rotation = 320, size = LARGE, laserDelay = 0.8, laserLength = 0.9, s1 = false, s2 = false }))
table.insert(gbs, oblib.GasterBlaster.new({ startX = 730, startY = 240, endX = 550, endY = 80, time = ourTime+6.9, rotation = 90, size = LARGE, laserDelay = 0.8, laserLength = 0.9, s1 = false, s2 = false }))
