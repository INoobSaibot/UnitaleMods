...
if (rand1 == 1) then
	rand2 = 2
	table.insert(gbs, oblib.GasterBlaster.new({ lifetime = 2, startX = -30, startY = -30, endX = 156, endY = 195, time = ourTime+0.7, rotation = 270, size = THIN, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false, rs1 = false, rs2 = false }))
	table.insert(gbs, oblib.GasterBlaster.new({ lifetime = 2, startX = -30, startY = 510, endX = 240+(rand3*40), endY = 360, time = ourTime+0.7, rotation = 0, size = THIN, laserDelay = 0.8, laserLength = 0.55 }))

else
	rand3 = 2
	table.insert(gbs, oblib.GasterBlaster.new({ lifetime = 2, startX = -30, startY = -30, endX = 156, endY = 115+(rand2*40), time = ourTime+0.7, rotation = 270, size = THIN, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false, rs1 = false, rs2 = false }))
	table.insert(gbs, oblib.GasterBlaster.new({ lifetime = 2, startX = -30, startY = 510, endX = 320, endY = 360, time = ourTime+0.7, rotation = 0, size = THIN, laserDelay = 0.8, laserLength = 0.55 }))
...
for i = 1.4,7,0.7 do
	...
	if (math.random() < 0.2) then
		table.insert(gbs, oblib.GasterBlaster.new({ lifetime = 2, startX = -30, startY = -30, endX = 156, endY = -42, time = ourTime+i, rotation = 270, size = THIN, laserDelay = 0.8, laserLength = 0.4, s1 = false, s2 = false }))
	else
		table.insert(gbs, oblib.GasterBlaster.new({ lifetime = 2, startX = -30, startY = -30, endX = 156, endY = 115+(rand2*40), time = ourTime+i, rotation = 270, size = THIN, laserDelay = 0.8, laserLength = 0.4, s1 = false, s2 = false }))
	end
	if (math.random() < 0.2) then
		table.insert(gbs, oblib.GasterBlaster.new({ lifetime = 2, startX = -30, startY = 510, endX = -42, endY = 360, time = ourTime+i, rotation = 0, size = THIN, laserDelay = 0.8, laserLength = 0.4 }))
	else
		table.insert(gbs, oblib.GasterBlaster.new({ lifetime = 2, startX = -30, startY = 510, endX = 240+(rand3*40), endY = 360, time = ourTime+i, rotation = 0, size = THIN, laserDelay = 0.8, laserLength = 0.4 }))
	end
end
...
for i = 0, numberOfCircs-1, 1 do
	...
	if (i == 0) then rs = 30
	elseif (i == 1) then rs = -30
	elseif (i == 2) then rs = 50
	elseif (i == 3) then rs = -50
	elseif (i == 4) then rs = 80
	elseif (i == 5) then rs = -80
	end
...
--This was an easy way to slightly tweak these bolts' starting time to make them sync well; keep track of the start of them in the array
...
function Update()
	...
	for i = #hints,1,-1 do
		--piano mode hint dots (test using these before actually making the bolts to hit player)
