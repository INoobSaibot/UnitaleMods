...
table.insert(gbs, oblib.GasterBlaster.new({ startX = -90, startY = 240, endX = 90, endY = 265, time = ourTime+6.9, rotation = 270, size = LARGE, laserDelay = 0.8, laserLength = 0.9, s1 = false, s2 = false }))
table.insert(gbs, oblib.GasterBlaster.new({ startX = 730, startY = 240, endX = 550, endY = 75, time = ourTime+6.9, rotation = 90, size = LARGE, laserDelay = 0.8, laserLength = 0.9, s1 = false, s2 = false }))
