...
table.insert(gbs, oblib.GasterBlaster.new( { startX = 670, startY = -30, endX = 510, endY = 200, time = ourTime+9, rotation = 90, size = NORMAL, laserDelay = 0.75, laserLength = 0.55, s1 = false, s2 = false }))
