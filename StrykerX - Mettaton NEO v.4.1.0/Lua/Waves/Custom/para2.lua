...
waveLength = 19
Encounter.SetVar("wavetimer", 19.0)
Arena.Resize(168,16)
	--This will create a line of 7 of the same object, spaced 24 pixels
	for i = 248,392,24 do
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -130, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 564, endX = 0, endY = -5000, xspeed = 0, yspeed = -130, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 588, endX = 0, endY = -5000, xspeed = 0, yspeed = -130, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 612, endX = 0, endY = -5000, xspeed = 0, yspeed = -130, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 636, endX = 0, endY = -5000, xspeed = 0, yspeed = -130, time = ourTime + 0, bottomScreenDead = true }))

		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 708, endX = 0, endY = -5000, xspeed = 0, yspeed = -130, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 732, endX = 0, endY = -5000, xspeed = 0, yspeed = -130, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 756, endX = 0, endY = -5000, xspeed = 0, yspeed = -130, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 780, endX = 0, endY = -5000, xspeed = 0, yspeed = -130, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 804, endX = 0, endY = -5000, xspeed = 0, yspeed = -130, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = i, startY = 828, endX = 0, endY = -5000, xspeed = 0, yspeed = -130, time = ourTime + 0, bottomScreenDead = true }))
	end
	for i = 248,296,48 do
		--Column of metts on the left and right
		table.insert(pmetts, oblib.Parasol.new( { startX = i, startY = 540, endX = 0, endY = 300, bounce = false, xspeed = 0, yspeed = 100, xspeed2 = 0, yspeed2 = 60, speedTime = 1.2, time = ourTime + 6.6, ammo = 10, delay = 3, firstShot = 1, flingDir = -1 }))
		table.insert(pmetts, oblib.Parasol.new( { startX = i, startY = 588, endX = 0, endY = 366, bounce = false, xspeed = 0, yspeed = 100, xspeed2 = 0, yspeed2 = 60, speedTime = 1.2, time = ourTime + 6.6, ammo = 10, delay = 3, firstShot = 1, flingDir = -1 }))
                     end
		table.insert(pmetts, oblib.Parasol.new( { startX = 272, startY = 564, endX = 0, endY = 333, bounce = false, xspeed = 0, yspeed = 100, xspeed2 = 0, yspeed2 = 60, speedTime = 1.2, time = ourTime + 6.6, ammo = 10, delay = 0.1, firstShot = 3, flingDir = -1 }))
	                     table.insert(bolts, oblib.Bolt.new( { simple = true, startX = 248, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -160, time = ourTime + 6.6 }))
	                     table.insert(bolts, oblib.Bolt.new( { simple = true, startX = 272, startY = 520, endX = 0, endY = -5000, xspeed = 0, yspeed = -160, time = ourTime + 6.6 }))
	                     table.insert(bolts, oblib.Bolt.new( { simple = true, startX = 296, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -160, time = ourTime + 6.6 }))

	                     table.insert(bolts, oblib.Bolt.new( { simple = true, startX = 248, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -160, time = ourTime + 9.0 }))
	                     table.insert(bolts, oblib.Bolt.new( { simple = true, startX = 272, startY = 560, endX = 0, endY = -5000, xspeed = 0, yspeed = -160, time = ourTime + 9.0 }))
	                     table.insert(bolts, oblib.Bolt.new( { simple = true, startX = 296, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -160, time = ourTime + 9.0 }))
	for i = 344,392,48 do
		table.insert(pmetts, oblib.Parasol.new( { startX = i, startY = 540, endX = 0, endY = 300, bounce = false, xspeed = 0, yspeed = 100, xspeed2 = 0, yspeed2 = 60, speedTime = 1.2, time = ourTime + 6.6, ammo = 10, delay = 3, firstShot = 1, flingDir = 1 }))
		table.insert(pmetts, oblib.Parasol.new( { startX = i, startY = 588, endX = 0, endY = 366, bounce = false, xspeed = 0, yspeed = 100, xspeed2 = 0, yspeed2 = 60, speedTime = 1.2, time = ourTime + 6.6, ammo = 10, delay = 3, firstShot = 1, flingDir = 1 }))
	end
		table.insert(pmetts, oblib.Parasol.new( { startX = 368, startY = 564, endX = 0, endY = 333, bounce = false, xspeed = 0, yspeed = 100, xspeed2 = 0, yspeed2 = 60, speedTime = 1.2, time = ourTime + 6.6, ammo = 10, delay = 0.1, firstShot = 3, flingDir = 1 }))
	                     table.insert(bolts, oblib.Bolt.new( { simple = true, startX = 344, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -160, time = ourTime + 6.6 }))
	                     table.insert(bolts, oblib.Bolt.new( { simple = true, startX = 368, startY = 520, endX = 0, endY = -5000, xspeed = 0, yspeed = -160, time = ourTime + 6.6 }))
	                     table.insert(bolts, oblib.Bolt.new( { simple = true, startX = 392, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -160, time = ourTime + 6.6 }))
  
	                     table.insert(bolts, oblib.Bolt.new( { simple = true, startX = 344, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -160, time = ourTime + 9.0 }))
	                     table.insert(bolts, oblib.Bolt.new( { simple = true, startX = 368, startY = 560, endX = 0, endY = -5000, xspeed = 0, yspeed = -160, time = ourTime + 9.0 }))
	                     table.insert(bolts, oblib.Bolt.new( { simple = true, startX = 392, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -160, time = ourTime + 9.0 }))
		table.insert(pmetts, oblib.Parasol.new( { startX = 250, startY = 540, endX = 0, endY = 160, bounce = false, xspeed = 0, yspeed = 100, xspeed2 = 0, yspeed2 = 60, speedTime = 1.2, time = ourTime + 3.8, ammo = 10, delay = 2, firstShot = 1.2, flingDir = -1 }))
		table.insert(pmetts, oblib.Parasol.new( { startX = 382, startY = 540, endX = 0, endY = 160, bounce = false, xspeed = 0, yspeed = 100, xspeed2 = 0, yspeed2 = 60, speedTime = 1.2, time = ourTime + 3.8, ammo = 10, delay = 2, firstShot = 1.2, flingDir = 1 }))
		table.insert(pmetts, oblib.Parasol.new( { startX = 250, startY = 672, endX = 0, endY = 226, bounce = false, xspeed = 0, yspeed = 100, xspeed2 = 0, yspeed2 = 60, speedTime = 1.2, time = ourTime + 3.8, ammo = 10, delay = 2, firstShot = 1.2, flingDir = -1 }))
		table.insert(pmetts, oblib.Parasol.new( { startX = 382, startY = 672, endX = 0, endY = 226, bounce = false, xspeed = 0, yspeed = 100, xspeed2 = 0, yspeed2 = 60, speedTime = 1.2, time = ourTime + 3.8, ammo = 10, delay = 2, firstShot = 1.2, flingDir = 1 }))
