...
--Square pattern
table.insert(gbs, oblib.GasterBlaster.new({ startX = 670, startY = 510, endX = PX, endY = 340, time = ourTime+0.7, rotation = 0, size = THIN, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false }))
...
--Square pattern
table.insert(gbs, oblib.GasterBlaster.new({ startX = -30, startY = -30, endX = PX, endY = 30, time = ourTime+3.3, rotation = 180, size = THIN, laserDelay = 0.8, laserLength = 0.55, s1 = false, s2 = false }))
