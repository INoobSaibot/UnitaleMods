...
-- This is some extremely messy code LOL!

waveLength = 11
Encounter.SetVar("wavetimer", 11.0)
Arena.Resize(168,130)
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 300, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -300, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 285, startY = 546, endX = 0, endY = -5000, xspeed = 0, yspeed = -150, time = ourTime + (24/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 186, startY = 640, endX = 0, endY = -5000, xspeed = 0, yspeed = -150, time = ourTime + (48/150), bottomScreenDead = true }))
		table.insert(pmetts, oblib.Parasol.new( { startX = 230, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 80, speedTime = 1.2, time = ourTime + 2.6, ammo = 2, delay = 1, firstShot = 1, flingDir = -1 }))
		table.insert(pmetts, oblib.Parasol.new( { startX = 440, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 80, speedTime = 1.2, time = ourTime + 2.6, ammo = 2, delay = 1, firstShot = 99, flingDir = 1 }))
		table.insert(pmetts, oblib.Parasol.new( { startX = 232, startY = 540, endX = 0, endY = 560, bounce = false, xspeed = 0, yspeed = 100, xspeed2 = 0, yspeed2 = 60, speedTime = 1.2, time = ourTime + 3.8, ammo = 10, delay = 1, firstShot = 1.2, flingDir = -1 }))
		table.insert(pbombs, oblib.PlusBomb.new( { simple = true, startX = 344, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -60, time = ourTime + 5.4, fuse = 1.5 }))
	table.insert(gbs, oblib.GasterBlaster.new( { startX = 670, startY = -30, endX = 510, endY = 268, time = ourTime+9, rotation = 90, size = NORMAL, laserDelay = 0.75, laserLength = 0.55, s1 = false, s2 = false }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 234, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -150, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 542, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -150, time = ourTime + (24/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 345, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -190, time = ourTime + (48/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 134, startY = 620, endX = 0, endY = -5000, xspeed = 0, yspeed = -120, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 342, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -150, time = ourTime + (24/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 245, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -10, time = ourTime + (48/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 250, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -170, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 360, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -160, time = ourTime + (48/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 234, startY = 620, endX = 0, endY = -5000, xspeed = 0, yspeed = -120, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 202, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -180, time = ourTime + (24/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 334, startY = 620, endX = 0, endY = -5000, xspeed = 0, yspeed = -120, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 402, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -155, time = ourTime + (24/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 342, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -154, time = ourTime + (24/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 245, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -105, time = ourTime + (48/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 200, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -131, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 512, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -162, time = ourTime + (24/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 234, startY = 620, endX = 0, endY = -5000, xspeed = 0, yspeed = -120, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 202, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -150, time = ourTime + (24/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 275, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -100, time = ourTime + (48/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 334, startY = 620, endX = 0, endY = -5000, xspeed = 0, yspeed = -120, time = ourTime + 0, bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 402, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -150, time = ourTime + (24/150), bottomScreenDead = true }))
		table.insert(sboxes, oblib.ShootableBox.new( { simple = true, startX = 375, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -100, time = ourTime + (48/150), bottomScreenDead = true }))
		table.insert(pbombs, oblib.PlusBomb.new( { simple = true, startX = 354, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = -150, time = ourTime + 2.2, fuse = 2 }))
		table.insert(pmetts, oblib.Parasol.new( { startX = 200, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 80, speedTime = 1.2, time = ourTime + 2.6, ammo = 0, delay = 1, firstShot = 1, flingDir = -1 }))
		table.insert(pmetts, oblib.Parasol.new( { startX = 560, startY = 540, endX = 0, endY = -5000, xspeed = 0, yspeed = 200, xspeed2 = 0, yspeed2 = 80, speedTime = 1.2, time = ourTime + 2.6, ammo = 2, delay = 1, firstShot = 1, flingDir = 1 }))
		table.insert(pmetts, oblib.Parasol.new( { startX = 345, startY = 540, endX = 0, endY = 260, bounce = false, xspeed = 0, yspeed = 100, xspeed2 = 0, yspeed2 = 60, speedTime = 1.2, time = ourTime + 3.8, ammo = 10, delay = 1, firstShot = 1.2, flingDir = -1 }))
		table.insert(pbombs, oblib.PlusBomb.new( { simple = true, startX = 350, startY = 520, endX = 0, endY = -5000, xspeed = 0, yspeed = -110, time = ourTime + 2.4, fuse = 3.4 }))
		table.insert(pbombs, oblib.PlusBomb.new( { simple = true, startX = 400, startY = 700, endX = 0, endY = -5000, xspeed = 0, yspeed = -240, time = ourTime + 1.4, fuse = 1.5 }))
		table.insert(pbombs, oblib.PlusBomb.new( { simple = true, startX = 520, startY = 520, endX = 0, endY = -5000, xspeed = 0, yspeed = -99, time = ourTime + 2.4, fuse = 3.1 }))
		table.insert(pbombs, oblib.PlusBomb.new( { simple = true, startX = 200, startY = 500, endX = 0, endY = -5000, xspeed = 0, yspeed = -140, time = ourTime + 1.4, fuse = 2.2 }))
	table.insert(gbs, oblib.GasterBlaster.new( { startX = 670, startY = -30, endX = 510, endY = 268, time = ourTime+9, rotation = 90, size = NORMAL, laserDelay = 0.75, laserLength = 0.55, s1 = false, s2 = false }))
		table.insert(pbombs, oblib.PlusBomb.new( { simple = true, startX = 250, startY = 520, endX = 0, endY = -5000, xspeed = 0, yspeed = -130, time = ourTime + 3.4, fuse = 2.4 }))
		table.insert(pbombs, oblib.PlusBomb.new( { simple = true, startX = 320, startY = 520, endX = 0, endY = -5000, xspeed = 0, yspeed = -111, time = ourTime + 2.4, fuse = 3.1 }))
