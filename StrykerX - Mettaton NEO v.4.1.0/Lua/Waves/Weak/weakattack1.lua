...
table.insert(gbs, oblib.GasterBlaster.new({ startX = 670, startY = 510, endX = 320, endY = 340, time = ourTime+0.2, rotation = 0, size = THIN, laserDelay = 0.77, laserLength = 0.55, s1 = false, s2 = false }))

table.insert(gbs, oblib.GasterBlaster.new({ startX = -30, startY = 510, endX = 130, endY = 182, time = ourTime+0.7, rotation = 270, size = THIN, laserDelay = 0.77, laserLength = 0.55, s1 = false, s2 = false }))

table.insert(gbs, oblib.GasterBlaster.new({ startX = -30, startY = -30, endX = 245, endY = 30, time = ourTime+1.5, rotation = 180, size = THIN, laserDelay = 0.75, laserLength = 0.55, s1 = false, s2 = false }))

table.insert(gbs, oblib.GasterBlaster.new({ startX = 670, startY = -30, endX = 510, endY = 128, time = ourTime+2.0, rotation = 90, size = THIN, laserDelay = 0.75, laserLength = 0.55, s1 = false, s2 = false }))

--Blue lasers here, as well as -42 gaster blasters
table.insert(bots, oblib.LaserBot.new( { simple = true, startX = 700, startY = 300,  time = ourTime+3.6, xspeed = -150, rotation = 0, color = BLUE }))
